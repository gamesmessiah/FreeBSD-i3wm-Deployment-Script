...
# Version 3.1.0 - Added Display Server Selection (X.Org vs XLibre)
...
echo "1) Standard X.Org"
echo "2) XLibre (Drop-in X.Org Replacement)"
echo "-------------------------------------------------------"
read -r SERVER_CHOICE

case $SERVER_CHOICE in
    2)
        SERVER_PKG="x11/xlibre"
        ;;
    *)
        SERVER_PKG="xorg"
        ;;
...
echo "-------------------------------------------------------"
echo "Setup Complete! Version 3.1.0 script ready."
echo "-------------------------------------------------------"
